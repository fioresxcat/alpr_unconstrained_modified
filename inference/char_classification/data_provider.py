...
from . import data_utils_original
...
class Datasets(object):
    def __init__(self):
        ...
        # Input data
        self.digits_data = data_utils_original.get_digits_data('./data/digits.npy')
        self.alphas_data = data_utils_original.get_alphas_data('./data/alphas.npy')
