...
test_dir = Path(r'C:\Users\Fiores\Desktop\Modified Model Train And Loss\đã chỉnh loss\ket qua trich xuat bien so\test_resized_result_modified')
val_dir = Path(r'C:\Users\Fiores\Desktop\Modified Model Train And Loss\đã chỉnh loss\ket qua trich xuat bien so\val_resized_result_modified')
# (470,110) (280,200)
