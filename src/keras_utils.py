...
def reconstruct(Iorig, I, Y, out_size, threshold=.9):
    ...
    # We set α = 7.75, which is the mean point between the maximum and minimum LP
    ...
    if len(final_labels):
        ...
        for i, label in enumerate(final_labels):
            ...
            TLps.append(Ilp)  # Ilp là ảnh các biển số đã xoay thẳng
...
def detect_lp(model, I, max_dim, net_step, out_size, threshold):
    ...
    # đây là bước resize lại ảnh. Nếu bb của vehicle dài => resize to hơn. Nếu bb vuông => resize ngắn hơn
