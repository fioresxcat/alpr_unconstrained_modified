...
def end_block(x):
	...
	xlptype   = Conv2D(2, 3, activation='softmax', padding='same')(x)  ########## fix: thêm 1 channel trong output đại diện cho loại biển số
	return Concatenate(3)([xprobs,xbbox,xlptype])          ############ fix
